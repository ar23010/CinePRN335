...
@Override
    ...
    for(TipoSala registro : registros){
            sw.append("<tr>").append("<td>").append(registro.getIdTipoSala().toString()).append("</td><td>").append(registro.getNombre()).append("</td><td>").append(registro.getActivo()?"Activo":"Inactivo").append("</td><td>").append(registro.getComentarios()).append("</td><td>").append(registro.getExpresionRegular()).append("</td><td>").append(registro.getExpresionRegular()).append("</td></tr>");
    }
